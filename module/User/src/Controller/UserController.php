...
class UserController extends AbstractActionController
{
     ...
     * Constructor.
     */
    public function __construct($entityManager, $userManager, $authService, $basePath)
    {
    ...
    /**
     * This action displays a page allowing to change profile's password.
     */
    public function changeProfilePasswordAction()
    {
        ...
        $vm->setTemplate('user/user/change-password');
        return $vm;
    }
    ...
    public function changePasswordAction()
    {
        ...
        // Create "change password" form
        $form = new PasswordChangeForm($scenario);
